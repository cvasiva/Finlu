...
const RegisterYour = ({ navigation }) => {
    ...
    return (
        <View style={styles.container}>
            ...
            <Text style={styles.subtitle}>Create your profile, fill the following details</Text>
            ...
            <Text style={styles.subtitle}>Send my transaction reports to</Text>
...
const styles = StyleSheet.create({
    ...
    separator: { height: 1, backgroundColor: 'black', marginBottom: 15 },
    ...
    errorInput: { borderColor: 'red', backgroundColor: '#fde8e8' },
    filledInput: { borderColor: '#ccc' },
    orText: { textAlign: 'center', marginVertical: 10, fontSize: 12, color: 'gray' },
    button: { backgroundColor: '#b3263a', padding: 12, borderRadius: 8, alignItems: 'center', marginTop: 150 },
    ...
    otpInput: { width: 50, height: 50, borderWidth: 1, borderColor: '#ccc', borderRadius: 10, fontSize: 22, textAlign: 'center', color: '#000' },
